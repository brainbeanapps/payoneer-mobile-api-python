...
class PaymentMethodResponse(object):
    ...
    """
    def __init__(self, mobile_account_id=None, type=None, primary_field=None, secondary_field=None, display_name_resource=None, use_secondary_field=None, status=None, currency=None, balance=None, status_category=None, allow_transactions=None):
        """
